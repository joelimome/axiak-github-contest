...
inline
void 
diskio::save_arma_ascii(const Mat<eT>& x, const std::string& name, std::ofstream& f)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::save_arma_binary(const Mat<eT>& x, const std::string& name, std::ofstream& f)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::save_pgm_binary(const Mat< std::complex<T> >& x, const std::string& name)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::load_arma_ascii(Mat<eT>& x, const std::string& name, std::ifstream& f)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::load_arma_binary(Mat<eT>& x, const std::string& name, std::ifstream& f)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::save_field_arma_binary(const field<T1>& x, const std::string& final_name)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::load_field_arma_binary(field<T1>& x, const std::string& name)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::save_field_ppm_binary(const field<T1>& x, const std::string& final_name)
  {
  arma_extra_debug_sigprint();
  ...
  arma_debug_check( (x.n_elem != 3), "diskio::save_field_ppm_binary(): given field must have exactly 3 matrices of equal size" );
  ...
  arma_debug_check( (same_size != true), "diskio::save_field_ppm_binary(): given field must have exactly 3 matrices of equal size" );
...
inline
void
diskio::load_field_ppm_binary(field<T1>& x, const std::string& name)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::save_field_std_string(const field<std::string>& x, const std::string& final_name)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::load_field_std_string(field<std::string>& x, const std::string& name)
  {
  arma_extra_debug_sigprint();
...
inline
void
diskio::load_field_auto_detect(field<T1>& x, const std::string& name)
  {
  arma_extra_debug_sigprint();
